...
class SelectIndexHandler(AskUserEventHandler):
    ...
    def ev_keydown(self, event: tcod.evemt.KeyDown) -> Optional[ActionOrHandler]:
...
class AreaRangedAttackHandler(SelectIndexHandler):
    """
    Handles targeting in an area within a given radious.
    ...
    def on_render(self, console: tcod.console.Console) -> None:
        ...
        #Draw a rectangle around the targeted aread, so the player can see the affected tiles.
        console.draw_frame(
            x=x - self.radius - 1,
            y=y - self.radius - 1,
            width=self.radius ** 2,
